...
/**
 * A class for save SeaCreatures.Jellyfish object and perform actions
 *
...
public class Jellyfish extends Swimmable implements MarineAnimal {
    ...
    /**
     * Instantiates a new SeaCreatures.Jellyfish.
     *
     * @param size     the size
    ...
    /**
     * Instantiates a new SeaCreatures.Jellyfish. Default constructor
     */
    public Jellyfish() {
        this(0, 0, 0, 0, 0, 1, 10);
    }
    ...
    /**
     * Instantiates a new SeaCreatures.Jellyfish. copy constructor
     *
    ...
    /**
     * @return the size of the jellyfish
     */
    @Override
    public int getSize() {
        return size;
    ...
    /**
     * Change jellyfish. changing the jellyfish size
     */
    ...
    public boolean equals(Object o) {
        ...
        return getEAT_DISTANCE() == jellyfish.getEAT_DISTANCE() && getSize() == jellyfish.getSize() && getCol() == jellyfish.getCol() && getEatCount() == jellyfish.getEatCount() && getX_front() == jellyfish.getX_front() && getY_front() == jellyfish.getY_front() && getX_dir() == jellyfish.getX_dir() && getY_dir() == jellyfish.getY_dir();
    }

    /**
     * method for drawing the SeaCreatures.Jellyfish on the screen
     *
     * @param g (Graphics)
     */
    @Override
